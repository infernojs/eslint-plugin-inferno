# Enforce or disallow spaces inside of curly braces in JSX attributes. (inferno/jsx-curly-spacing)
...
```json
"inferno/jsx-curly-spacing": [2, "never", {"allowMultiline": false}]
```
...
```json
"inferno/jsx-curly-spacing": [2, "always", {"spacing": {
