...
/**
 * Check whether given node is `ReturnStatement` of a Inferno hook
 * @param {ASTNode} node The AST node
 * @param {Context} context eslint context
 * @returns {Boolean} True if node is a `ReturnStatement` of a Inferno hook, false if not
 */
...
module.exports = {
  ...
  create: Components.detect((context, components, utils) => {
     ...
     *   render() {
     *     class NestedClassComponent extends Inferno.Component {
     * ...
     * ```
     ...
     * ```js
     * Inferno.createElement(Component, {
    ...
    function validate(node) {
      ...
      if (parentComponent) {
        ...
        // Inferno prevents creating lowercase components
