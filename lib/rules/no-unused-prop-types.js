...
module.exports = {
  ...
  create: Components.detect(function(context, components, utils) {
     ...
     */
    function buildInfernoDeclarationTypes(value, parentName) {
      if (
        value &&
        value.callee &&
        value.callee.object &&
        ...
        switch (callName) {
          case 'shape':
            ...
            iterateProperties(argument.properties, function(childKey, childValue) {
              ...
              var types = buildInfernoDeclarationTypes(childValue, fullName);
              if (types === true) {
                types = {};
              }
          ...
          case 'objectOf':
            ...
            var child = buildInfernoDeclarationTypes(argument, fullName);
            if (child === true) {
              child = {};
            }
          ...
          case 'oneOfType':
            ...
            for (var i = 0, j = argument.elements.length; i < j; i++) {
              var type = buildInfernoDeclarationTypes(argument.elements[i], parentName);
      ...
      switch (propTypes && propTypes.type) {
        ...
        case 'ObjectExpression':
          iterateProperties(propTypes.properties, function(key, value) {
            ...
            var types = buildInfernoDeclarationTypes(value, key);
            if (types === true) {
              types = {};
            }
            types.fullName = key;
