...
class Components {
  ...
  addDefaultInfernoImport(specifier) {
    ...
    InfernoImports.set(this, Object.assign({}, info, {
      defaultInfernoImports: (info.defaultInfernoImports || []).concat(specifier),
    }));
  }
  ...
  addNamedInfernoImport(specifier) {
    const info = InfernoImports.get(this);
    InfernoImports.set(this, Object.assign({}, info, {
      namedInfernoImports: (info.namedInfernoImports || []).concat(specifier),
    }));
  }
}
...
function componentRule(rule, context) {
  ...
  const allKeys = new Set(Object.keys(detectionInstructions).concat(
    ...
    Object.keys(InfernoImportInstructions)
  ));
  ...
  allKeys.forEach((instruction) => {
    updatedRuleInstructions[instruction] = (node) => {
      ...
      if (instruction in InfernoImportInstructions) {
        InfernoImportInstructions[instruction](node);
      }
