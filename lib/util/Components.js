  ...
  var utils = {
    ...
    isExplicitComponent: function(node) {
      ...
      var relevantTags = commentAst.tags.filter(function(tag) {
        return tag.name === 'Inferno.Component' || tag.name === 'Inferno.PureComponent';
      });
    ...
    isReturningJSX: function(ASTnode, strict) {
      ...
      ;
      var returnsInfernoCreateElement =
        this.hasDestructuredInfernoCreateElement() ||
        this.isInfernoCreateElement(node[property])
      ;
