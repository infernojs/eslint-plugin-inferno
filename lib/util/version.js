/**
 * @fileoverview Utility functions for Inferno version configuration
...
function getFromContext(context) {
  ...
  if (context.settings.inferno && context.settings.inferno.version) {
    confVer = context.settings.inferno.version;
  }
