...
ruleTester.run('boolean-prop-naming', rule, {
  valid: parsers.all([
    ...
    {
      // createClass components with PropTypes
      code: `
        var Hello = createClass({
    ...
    {
      // createClass components with Inferno.PropTypes
      code: `
        var Hello = createClass({
          propTypes: {isSomething: Inferno.PropTypes.bool},
          render: function() { return <div />; }
        });
      `,
      options: [{ rule: '^is[A-Z]([A-Za-z0-9]?)+' }],
    ...
    {
      // Inferno.createClass components with PropTypes
      code: `
    ...
    {
      // Inferno.createClass components with non-boolean PropTypes
      code: `
        var Hello = Inferno.createClass({
    ...
    {
      // ES6 components as Inferno.Component with boolean PropTypes
      code: `
    ...
    {
      // ES6 components as Inferno.Component with non-boolean PropTypes
      code: `
        class Hello extends Inferno.Component {
          render () { return <div />; }
        }
    ...
    {
      // ES6 components with static class properties and Inferno.PropTypes
      code: `
        class Hello extends Inferno.Component {
          static propTypes = {isSomething: Inferno.PropTypes.bool};
          render () { return <div />; }
        }
      `,
      options: [{ rule: '^is[A-Z]([A-Za-z0-9]?)+' }],
    ...
    },
    {
      ...
      code: `
        ...
        function Hello(props: Props): Inferno.Element { return <div /> }
      `,
      options: [{ rule: '^is[A-Z]([A-Za-z0-9]?)+' }],
      features: ['flow'],
    },
    ...
    },
    {
      code: `
        ...
        const HelloNew: Inferno.FC<Props> = (props) => { return <div /> };
      `,
      options: [{ rule: '^is[A-Z]([A-Za-z0-9]?)+' }],
      features: ['types'],
    },
    ...
    {
      code: `
        export const DataRow = (props: { label: string; value: string; } & Inferno.HTMLAttributes<HTMLDivElement>) => {
  ...
  invalid: parsers.all([
    ...
    },
    {
      ...
      code: `
        var Hello = createClass({
          propTypes: {something: Inferno.PropTypes.bool},
          render: function() { return <div />; }
        });
      `,
      options: [{ rule: '^is[A-Z]([A-Za-z0-9]?)+' }],
    ...
    {
      // ES6 components as Inferno.Component with non-boolean PropTypes and Object.spread syntax
      code: `
        const spreadProps = { aSpreadProp: PropTypes.string };
        class Hello extends Component {
          render () { return <div />; }
    ...
    {
      // ES6 components as Inferno.Component with static class property, non-boolean PropTypes, and Object.spread syntax
      code: `
        const spreadProps = { aSpreadProp: PropTypes.string };
        class Hello extends Inferno.Component {
    ...
    {
      code: `
      class Card extends Inferno.Component {
        render() {
          return <div>{props.showScore ? 'yeh' : 'no'}</div>;
        }
      }
