...
ruleTester.run('checked-requires-onchange-or-readonly', rule, {
  valid: parsers.all([
    ...
    "Inferno.createElement('input', { checked: true, onChange: noop })",
    "Inferno.createElement('input', { checked: false, onChange: noop })",
    "Inferno.createElement('input', { checked: true, readOnly: true })",
    "Inferno.createElement('input', { checked: true, onChange: noop, readOnly: true })",
    "Inferno.createElement('input', { checked: foo, onChange: noop, readOnly: true })",
    {
  ...
  invalid: parsers.all([
    ...
    {
      code: 'Inferno.createElement("input", { checked: false })',
      errors: [{ messageId: 'missingProperty' }],
    },
    {
      code: 'Inferno.createElement("input", { checked: true, defaultChecked: true })',
      errors: [
        { messageId: 'exclusiveCheckedAttribute' },
        { messageId: 'missingProperty' },
      ],
