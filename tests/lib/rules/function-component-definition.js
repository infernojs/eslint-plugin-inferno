...
ruleTester.run('function-component-definition', rule, {
  valid: parsers.all([
    ...
    {
      code: 'const Foo = Inferno.memo(function Foo() { return <p/> })',
      options: [{ namedComponents: 'function-declaration' }],
    },
    {
    ...
    {
      code: 'var Hello: Inferno.FC<Test> = function(props) { return <p/> }',
      options: [{ namedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'var Hello: Inferno.FC<Test> = (props) => { return <p/> }',
      options: [{ namedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
    ...
    {
      code: 'var Hello = function(props): InfernoNode { return <p/> }',
      options: [{ namedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'var Hello = (props): InfernoNode => { return <p/> }',
      options: [{ namedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
      code: 'function wrapper() { return function(props): InfernoNode { return <p/> } }',
      options: [{ unnamedComponents: 'function-expression' }],
      features: ['types'],
    },
    {
      code: 'function wrapper() { return (props): InfernoNode => { return <p/> } }',
      options: [{ unnamedComponents: 'arrow-function' }],
      features: ['types'],
    },
    {
  ...
  invalid: parsers.all([
    ...
    {
      code: `
        var Hello: Inferno.FC<Test> = (props) => {
          return <div/>;
        }
      `,
      output: `
        var Hello: Inferno.FC<Test> = function(props) {
          return <div/>;
        }
      `,
      options: [{ namedComponents: 'function-expression' }],
    ...
    },
    {
      code: `
        function wrap(Component) {
          return function(props): InfernoNode {
            return <div><Component {...props}/></div>
          }
        }
      `,
