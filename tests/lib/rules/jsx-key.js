...
ruleTester.run('jsx-key', rule, {
  valid: parsers.all([
    ...
    { code: 'Inferno.Children.toArray([1, 2 ,3].map(x => <App />));' },
    {
      code: `
        import { Children } from "inferno";
    ...
    },
    {
      ...
      code: `
        import Act from 'inferno';
        import { Children as InfernoChildren } from 'inferno';
        ...
        // InfernoChildren.toArray([1, 2 ,3].map(x => <App />));
        // InfernoChildren.toArray(Array.from([1, 2 ,3], x => <App />));
